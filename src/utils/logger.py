...
def setup_logger(
    ...
    if run_level is RunLevelEnum.PRODUCTION and loki_config is not None:
        # Use Loki handler
        loki_handler = logging_loki.LokiHandler(
            url=loki_config.url,
            tags={"application": "ag-bot"},
            auth=(loki_config.user, loki_config.password),
            version=loki_config.version,
        )
